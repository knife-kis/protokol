...
final class SoundInsulationProtocolIssuanceSheetExporter {
    private static final String ISSUANCE_SHEET_NAME = "лист выдачи протоколов.docx";
    private static final String FONT_NAME = "Arial";
    private static final int FONT_SIZE = 12;

    private SoundInsulationProtocolIssuanceSheetExporter() {
    }
    ...
    private static void applyStandardHeader(XWPFDocument document) {
        ...
        setHeaderCellText(tbl.getRow(0).getCell(0), "Испытательная лаборатория ООО «ЦИТ»");
        setHeaderCellText(tbl.getRow(0).getCell(1), "Лист выдачи протоколов Ф17 ДП ИЛ 2-2023");
